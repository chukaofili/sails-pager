...
module.exports = {
    paginate: function(model, criteria, currentPage, perPage, populate_data, sort, cb) {
    ...
    paginatePopulate: function(model, criteria, currentPage, perPage, populate_data, populate_sort, cb) {
        return new Promise(function(resolve, reject) {
            var pagination = {
                page: parseInt(currentPage) || 1,
                limit: parseInt(perPage) || 20
            ...
            model.findOne(conditions).populate(populate_data).then(function(data) {
                ...
                var findQuery = model.findOne(conditions).populate(populate_data, {
                    skip: skip,
